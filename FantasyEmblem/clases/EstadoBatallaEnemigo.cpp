...
EstadoBatallaEnemigo::EstadoBatallaEnemigo(){
...
void EstadoBatallaEnemigo::init_State(){
    ...
    batasonido1->setVolume(50);
    batasonido1->play();
    mostrarDats();
}

void EstadoBatallaEnemigo::mostrarDats(){
...
void EstadoBatallaEnemigo::render_State(){
...
void EstadoBatallaEnemigo::update_State(){
        ...
        per1->setTextureRect(IntRect(contPer1i*248,contPer1j*160,248,160));
            ...
            if(atacado==false){
                ...
                if(contPer2i==7 && contPer2j== 6){
                    ...
                    aux= rand()%(101-1);
                    if(aux<=enem->PosiGolpearTotal(alia)){
            ...
            if(turno2==true){
                if(atacado2==false){
                    ...
                    if(contPer1i==7 && contPer1j== 5){
                        ...
                        aux2=rand()%(101-1);
                        if(aux2<=alia->PosiGolpearTotal(enem)){
            ...
            if(enem->GolpesDoble(alia)==2 && alia->GolpesDoble(enem)==1 && atacado2==true){
                atacado=false;
                //atacado2=false;
                //turno2=false;
                atacar2=true;
            } else if(enem->GolpesDoble(alia)==1 && alia->GolpesDoble(enem)==2 && atacado2==true){
                atacado2=false;
                //atacado2=false;
                //turno2=false;
                atacar2=true;
            }if(enem->GolpesDoble(alia)==2 && alia->GolpesDoble(enem)==2 && atacado2==true){
                atacado=false;
                atacado2=false;
                turno2=false;
                atacar2=true;
            }if(enem->GolpesDoble(alia)==1 && alia->GolpesDoble(enem)==1 && atacado2==true){
                //atacado=false;
                //atacado2=false;
                //turno2=false;
                reini=true;
...
void EstadoBatallaEnemigo::input() {
