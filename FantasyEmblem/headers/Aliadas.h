...
public:
    Aliadas();
    Aliadas(const char* name, const char* clas, int atributo[],int nivel, int rang, const char* nombreTextu,const char* textuBatalla , int experien, Objetos** obj, Armas** arm);
    virtual ~Aliadas();    
