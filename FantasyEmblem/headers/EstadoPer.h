...
public:
    static EstadoPer* Instance(Mapa* map, Aliadas** al, Enemigo** ene, Cofre** cofr, int *indice,bool *turno, Aliadas* alis);
    void input();
    void mostrarDatos();
    void mostrarStats();
...
protected:
    EstadoPer();
    EstadoPer(Mapa* map, Aliadas** al, Enemigo** ene, Cofre** cofr, int *indice,bool *turno, Aliadas* alis);
    ~EstadoPer();        
private:
