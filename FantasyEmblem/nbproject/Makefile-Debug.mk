...
${OBJECTDIR}/clases/Celda.o: clases/Celda.cpp 
	${MKDIR} -p ${OBJECTDIR}/clases
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSFML_STATIC -I../SFML-2.1/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clases/Celda.o clases/Celda.cpp
...
${OBJECTDIR}/clases/EstadoBatallaEnemigo.o: clases/EstadoBatallaEnemigo.cpp 
	${MKDIR} -p ${OBJECTDIR}/clases
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSFML_STATIC -I../SFML-2.1/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clases/EstadoBatallaEnemigo.o clases/EstadoBatallaEnemigo.cpp
...
${OBJECTDIR}/clases/EstadoPer.o: clases/EstadoPer.cpp 
	${MKDIR} -p ${OBJECTDIR}/clases
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSFML_STATIC -I../SFML-2.1/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clases/EstadoPer.o clases/EstadoPer.cpp

${OBJECTDIR}/clases/EstadoSumarExp.o: clases/EstadoSumarExp.cpp 
	${MKDIR} -p ${OBJECTDIR}/clases
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSFML_STATIC -I../SFML-2.1/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clases/EstadoSumarExp.o clases/EstadoSumarExp.cpp
...
${OBJECTDIR}/clases/GameOver.o: clases/GameOver.cpp 
	${MKDIR} -p ${OBJECTDIR}/clases
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSFML_STATIC -I../SFML-2.1/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clases/GameOver.o clases/GameOver.cpp
...
${OBJECTDIR}/clases/SubirNivel.o: clases/SubirNivel.cpp 
	${MKDIR} -p ${OBJECTDIR}/clases
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSFML_STATIC -I../SFML-2.1/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clases/SubirNivel.o clases/SubirNivel.cpp
